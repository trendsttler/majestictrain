...
public class Connection
{
    ...
    public Connection()
	{
        ...
        string aa = ConfigurationManager.ConnectionStrings["membercon2"].ConnectionString.ToString();


        con.ConnectionString = ConfigurationManager.ConnectionStrings["membercon2"].ConnectionString.ToString();
	}
