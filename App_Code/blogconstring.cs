...
/// <summary>
/// Summary description for blogconstring
/// </summary>
public class blogconstring
{
	...
	public blogconstring()
	{
        ...
        con.ConnectionString = ConfigurationManager.ConnectionStrings["conblog"].ConnectionString.ToString();
	}
